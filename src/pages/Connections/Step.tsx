...
export const TourStep = ({ onSubmit, onSubmitInfu }: Props) => {
        ...
        steps={[
          {
            content: ({ close }) => (
              <div>
                ...
                <div className="mt-4">
                  <h4 className="text-primary font-weight-bold text-center">
                    Welcome to Datalink!
                  </h4>
                  <p className="text-primary text-dark text-center">
                    We made the setup very simple.
                  </p>
                </div>
              </div>
            )
